          ...
          <div className="container mt-5">
            <div className="text-center mb-5">
              <h2 className="fw-bold">
                Welcome to{" "}
                <span className="text-primary">[Car Rental System]</span>!
              </h2>
              <p className="lead">
            ...
            <div className="row mb-5">
              ...
              <div className="col-md-6">
                ...
                <p>
                  Founded in <strong>[2019]</strong>, we aim to redefine car
                  rentals by making it simple and hassle-free. Whether it's a
                  family trip, business meeting, or a quick getaway, our cars
                  are always ready to hit the road with you.
                </p>
                <p>
                ...
                <div className="card border-primary shadow-sm">
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      Choose from a variety of vehicles that fit your every
                      need.
                    </p>
                  </div>
                </div>
            ...
            <div className="text-center">
              ...
              <p>
                Email:{" "}
                <a href="mailto:support@carrentalsystem.com">
